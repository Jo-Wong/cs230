...
flags.DEFINE_integer('num_layer_y',3, 'Constraint Weight yx')
...
flags.DEFINE_integer('train_batch_size', 100, 'Train Batch size.')  #flags.DEFINE_integer('batch_size', 1500, 'Batch size.')
...
with tf.Session(config=config) as sess:
  ...
  data_manager = DataManager('/scratch/groups/rwr/joswong/VM-NET/data/')
  train_batch = data_manager.batch_iterator_thread(FLAGS.train_batch_size)
  #validation_batch = data_manager.batch_iterator_thread(FLAGS.validation_batch_size, is_train=False)
